...
import ru.menuvoting.util.ValidationUtil;
import ru.menuvoting.util.exception.*;
...
public class ExceptionInfoHandler {
    ...
    private static final Map<String, String> CONSTRAINS_VALIDATION_MAP = Map.of(
            ...
            "menus_unique_date_restaurantid_idx", EXCEPTION_DUPLICATE_DATE,
    ...
    @ResponseStatus(value = HttpStatus.UNPROCESSABLE_ENTITY)  // 422
    @ExceptionHandler({IllegalRequestDataException.class, TimeVotingException.class, CreateMenuForDateException.class,
